...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RutaIA" },
      { property: "og:title", content: "RutaIA" },
      { name: "twitter:title", content: "RutaIA" },
      { name: "description", content: "Page Enhancer analyzes web pages and suggests improvements, allowing users to modify text content and header elements." },
      { property: "og:description", content: "Page Enhancer analyzes web pages and suggests improvements, allowing users to modify text content and header elements." },
      { name: "twitter:description", content: "Page Enhancer analyzes web pages and suggests improvements, allowing users to modify text content and header elements." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/npJsMHJ74vNrLy2SrSv3mUMfv0E2/social-images/social-1781529123512-1000672221.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/npJsMHJ74vNrLy2SrSv3mUMfv0E2/social-images/social-1781529123512-1000672221.webp" },
    ],
    links: [
